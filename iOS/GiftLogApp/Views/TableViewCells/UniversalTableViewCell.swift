...
let UniversalTableViewCellIdentifier = "UniversalTableViewCell"

@objc protocol UniversalTableViewCellDelegate: class {
    @objc optional func shareButtonTappedFromCell(_ cell: UniversalTableViewCell)
}

class UniversalTableViewCell: MGSwipeTableCell {
    ...
    weak var ownDelegate: UniversalTableViewCellDelegate?
    ...
    func setContentFromPhoneBookContact(_ contact: APContact) {
        iconImageView.image = contact.thumbnail ?? UIImage(named: "contactThumb")
