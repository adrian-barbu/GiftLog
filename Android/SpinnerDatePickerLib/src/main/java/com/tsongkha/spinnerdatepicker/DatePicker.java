...
public class DatePicker extends FrameLayout {
    ...
    public DatePicker(Context context, ViewGroup root, int numberPickerStyle) {
        ...
        mDayPicker = (NumberPicker) inflater.inflate(R.layout.number_picker_day_month, mPickerContainer, true).findViewById(R.id.number_picker);
        ...
        mMonthPicker = (NumberPicker) inflater.inflate(R.layout.number_picker_day_month, mPickerContainer).findViewById(R.id.number_picker);;
        ...
        mYearPicker = (NumberPicker) inflater.inflate(R.layout.number_picker_year, mPickerContainer).findViewById(R.id.number_picker);
