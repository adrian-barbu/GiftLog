...
/**
 * @description     Contact Item Selectable (From Phone) Adapter
 *
 * @author          Adrian
 */
public class ContactItemSelectableFromPhoneAdapter<T> extends ArrayAdapter<fbContact> {
    ...
    public ContactItemSelectableFromPhoneAdapter(Context context, OnItemSelectedListener listener) {
